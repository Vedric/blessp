...
export class AuthPage {
  ...
  constructor(page: Page) {
    ...
    this.signInSubmit = page.locator('form').filter({ has: page.locator('input#email') }).locator('button[type="submit"]');
    ...
    this.signUpSubmit = page.locator('form').filter({ has: page.locator('input#email') }).locator('button[type="submit"]');
    ...
    this.goToSignUp = page.locator('main a[href="/signup"]');
    this.goToSignIn = page.locator('main a[href="/signin"]');
  }
