    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          {/* Panel */}
          <motion.div ref={panel} role="dialog" aria-modal="true" aria-labelledby={title ? titleId : undefined} aria-label={title ? undefined : 'Dialog'} tabIndex={-1}
          ...
          >
            ...
            <div className="mb-6 flex items-center justify-between">
              ...
              <button
                onClick={onClose}
                className="ml-auto p-1 text-neutral-500 transition-colors hover:text-neutral-900"
                aria-label="Close"
              >
                <X size={20} />
              </button>
