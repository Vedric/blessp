...
import { Package, CheckCircle, Clock, Truck, ShoppingBag, CreditCard } from 'lucide-react';
...
const TIMELINE_STEPS = [
  ...
  { status: 'paid', labelKey: 'orders.status.paid', icon: CreditCard },
            ...
            >
              ...
              <div className="flex-1 pt-1">
                <p
                  ...
                  style={{
                    color: isCompleted || isCurrent ? '#171717' : '#737373',
                  }}
                >
                  {t(step.labelKey)}
                </p>
