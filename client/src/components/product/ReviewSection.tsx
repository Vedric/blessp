...
export function ReviewSection({ productId }: ReviewSectionProps) {
  ...
  useDialogFocus(showForm, dialogRef, () => { if (!isSubmitting) setShowForm(false); });
  ...
  return (
    ...
    >
      ...
      <motion.div className="mt-2 h-px w-12 bg-[#a07a52]" variants={fadeSlideUp} />
        ...
        >
            ...
            {[5, 4, 3, 2, 1].map((star) => {
              ...
              return (
                <div key={star} className="flex items-center gap-3">
                  ...
                  <Star size={12} className="shrink-0 fill-[#a07a52] text-[#80603c]" />
                  <div className="h-2 flex-1 overflow-hidden rounded-full bg-neutral-100">
                    <motion.div
                      className="h-full rounded-full bg-[#a07a52]"
                      initial={{ width: 0 }}
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            {isAuthenticated && userReview && (
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  className="px-6 py-2 text-xs font-medium tracking-wider text-neutral-500 uppercase transition-colors hover:text-red-500"
                >
            ...
            {!isAuthenticated && (
              <Link
                to="/signin"
                className="border border-[#a07a52] px-6 py-3 text-sm font-medium tracking-widest text-[#80603c] uppercase transition-colors hover:bg-[#a07a52] hover:text-white"
              >
      ...
      <AnimatePresence>
        {showForm && (
          ...
          >
            <motion.div
              ref={dialogRef} role="dialog" aria-modal="true" aria-labelledby="review-form-title" tabIndex={-1}
              className="relative mx-4 max-h-[90vh] overflow-y-auto w-full max-w-lg bg-white p-8 shadow-xl"
            ...
            >
              <button
                ...
                className="absolute right-2 top-2 flex h-11 w-11 items-center justify-center text-neutral-500 transition-colors hover:text-neutral-900"
              >
                <X size={20} />
              </button>

              <h3 id="review-form-title" className="font-display text-xl font-light tracking-tight text-neutral-900">
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    maxLength={200}
                    className="mt-2 w-full border border-neutral-200 px-4 py-3 text-sm text-neutral-900 placeholder-neutral-400 outline-none transition-colors focus:border-[#a07a52]"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    maxLength={2000}
                    rows={4}
                    className="mt-2 w-full resize-none border border-neutral-200 px-4 py-3 text-sm text-neutral-900 placeholder-neutral-400 outline-none transition-colors focus:border-[#a07a52]"
