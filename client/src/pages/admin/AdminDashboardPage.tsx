          ...
          return (
            ...
            >
              ...
              <div className="mt-auto w-full">
                <div
                  className="w-full bg-[#a07a52]/70 transition-colors group-hover:bg-[#a07a52]"
                  style={{
    ...
    <div className="flex gap-0.5">
      {[1, 2, 3, 4, 5].map((n) => (
        <Star
          ...
          className={cn(
            'h-3.5 w-3.5',
            n <= rating ? 'fill-[#a07a52] text-[#80603c]' : 'text-neutral-200',
          )}
        />
      ))}
    </div>
        ...
        >
          ...
          >
            {overviewLoading
              ...
              : kpiCards.map((card) => (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#a07a52]/10">
                        <card.icon className="h-4 w-4 text-[#80603c]" />
                      </div>
                  ...
                  <div className="mt-6 space-y-3">
                    {topProducts.length === 0 ? (
                      ...
                      topProducts.map((product, i) => (
                        ...
                        >
                          <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center text-xs font-medium text-neutral-500">
                            {i + 1}
                          </span>
                    ...
                    reviews.map((review) => (
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="mt-0.5 text-xs text-[#80603c]">
                            {review.productName}
                          </p>
                          {review.title && (
          ...
          <div className="mt-12">
            ...
            <div className="mt-4 space-y-2">
              <Link to="/admin/contact" className="flex min-h-14 items-center justify-between border border-neutral-200 p-5 text-sm font-medium hover:bg-neutral-50">{t('support.title')}</Link>
              <Link to="/admin/inventory" className="flex min-h-14 items-center justify-between border border-neutral-200 p-5 text-sm font-medium hover:bg-neutral-50">{t('inventory.title')}<Package className="h-5 w-5" aria-hidden="true" /></Link>
              <Link
                to="/admin/products"
