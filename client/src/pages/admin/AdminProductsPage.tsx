...
export default function AdminProductsPage() {
  ...
  useDialogFocus(Boolean(deleteModal), dialogRef, () => { if (!isDeleting) setDeleteModal(null); });
        ...
        >
          ...
          <AnimatePresence>
            {deleteModal && (
              ...
              >
                <motion.div
                  ref={dialogRef} role="dialog" aria-modal="true" aria-labelledby="delete-product-title" tabIndex={-1}
              className="max-h-[90vh] overflow-y-auto w-full max-w-sm bg-white p-8 text-center"
                  initial={{ opacity: 0, scale: 0.95 }}
                  animate={{ opacity: 1, scale: 1 }}
                  exit={{ opacity: 0, scale: 0.95 }}
                  onClick={(e) => e.stopPropagation()}
                >
                  <h3 id="delete-product-title" className="text-lg font-medium text-neutral-900">
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Link
                      ...
                      className="p-2 text-neutral-500 transition-colors hover:text-neutral-700"
                    >
