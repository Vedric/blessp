...
const statusStyles: Record<string, { className: string; dot: string }> = {
  ...
  paid: { className: 'bg-emerald-50 text-emerald-700 border-emerald-200', dot: 'bg-emerald-500' },
  ...
  if (!order) {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4">
        ...
        <Link
          to="/profile/orders"
          className="text-sm font-medium text-[#80603c] underline underline-offset-4 transition-colors hover:text-neutral-900"
        >
    ...
    <div className="min-h-screen px-4 pt-8 pb-24 sm:px-6">
      <div className="mx-auto max-w-3xl">
        ...
        >
          ...
          >
            <div>
              <h1 className="break-words font-display text-3xl font-light tracking-tight text-neutral-900">
                Order #{orderRef}
              </h1>
          ...
          <motion.div className="mt-2 h-px w-12 bg-[#a07a52]" variants={fadeUp} />
            ...
            <motion.div className="border border-neutral-100 p-6" variants={fadeUp}>
              ...
              <div className="mt-4 space-y-3">
                ...
                {order.discountCents > 0 && (
                  <div className="flex justify-between text-sm">
                    <span className="text-neutral-500">{t('common.discount')}</span>
                    <span className="text-neutral-900">−{formatPrice(order.discountCents)}</span>
                  </div>
                )}
          ...
          <motion.div className="mt-8 text-center" variants={fadeUp}>
            <p className="text-sm text-neutral-500">
              ...
              <Link
                to="/contact"
                className="text-[#80603c] underline underline-offset-4 transition-colors hover:text-neutral-900"
              >
