...
const TIER_CONFIG: Record<LoyaltyTier, {
  ...
  Gold: {
    icon: Crown,
    color: 'text-[#80603c]',
    bgGradient: 'from-[#a07a52]/20 to-[#a07a52]/5',
    borderColor: 'border-[#a07a52]/40',
    threshold: 2000,
  },
  Platinum: {
    icon: Sparkles,
      ...
      <div className="mx-auto max-w-3xl">
        ...
        >
            ...
            {TIER_ORDER.map((tier) => {
              ...
              return (
                ...
                >
                  ...
                  <p className={cn('mt-1 text-xs font-medium', isActive ? 'text-neutral-900' : 'text-neutral-500')}>
                    {tier}
                  </p>
          ...
          {balance && balance.points >= 100 && (
            ...
            >
              <div className="flex items-center gap-3">
                <Gift className="h-5 w-5 text-[#80603c]" />
                <div>
                  ...
                  <p className="text-xs text-neutral-500">
                    ...
                    for a{' '}
                    <span className="font-medium text-[#80603c]">
          ...
          {redeemSuccess && <p role="status" className="mt-4 break-all border border-green-700 p-4 text-sm text-green-800">{redeemSuccess}</p>}
          ...
          >
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-3">
              <div>
                <Star className="h-4 w-4 text-[#80603c]" />
              ...
              <div>
                <Gift className="h-4 w-4 text-[#80603c]" />
              ...
              <div>
                <Crown className="h-4 w-4 text-[#80603c]" />
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {tx.couponCode && <p className="break-all font-mono text-sm text-neutral-800">{tx.couponCode}</p>}
                        <p className="text-2xs text-neutral-500">{formatDate(tx.createdAt)}</p>
                      </div>
                    </div>
                    <span
                      className={cn(
