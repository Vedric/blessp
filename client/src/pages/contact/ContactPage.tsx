...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen">
            ...
            <AnimatePresence mode="wait">
              {isSubmitted ? (
                ...
                >
                  ...
                  <motion.button
                    className="mt-8 text-sm font-medium tracking-widest text-brand-700 uppercase transition-colors hover:text-brand-700"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                ...
                >
                  ...
                  <div data-error={!!errors.name}>
                    ...
                    <input
                      ...
                      onBlur={handleBlur}
                      className={cn(
                        'mt-2 block w-full border-0 border-b bg-transparent px-0 py-3 text-neutral-900 placeholder:text-neutral-500 focus:border-brand-500 focus:ring-0 transition-colors',
                    ...
                    <div className="relative">
                      <select
                        ...
                        className={cn(
                          ...
                          !formData.subject && 'text-neutral-500',
                  ...
                  <div data-error={!!errors.message}>
                    ...
                    <textarea
                      ...
                      onBlur={handleBlur}
                      className={cn(
                        'mt-2 block w-full resize-none border-0 border-b bg-transparent px-0 py-3 text-neutral-900 placeholder:text-neutral-500 focus:border-brand-500 focus:ring-0 transition-colors',
            ...
            <motion.div className="mt-8 space-y-8" variants={fadeUp}>
              <div>
                ...
                <a
                  ...
                  className="mt-2 block text-neutral-600 transition-colors hover:text-brand-700"
                >
                  hello@blessp.com
                </a>
              </div>
              ...
              {socialLinks.length > 0 && <div>
                <p className="text-sm font-medium tracking-widest text-neutral-900 uppercase">{t('contact.info.followUs')}</p>
                <div className="mt-3 flex flex-wrap gap-4">{socialLinks.map(link => <a key={link.label} href={link.href} target="_blank" rel="noopener noreferrer" className="inline-flex min-h-11 items-center gap-2 text-sm text-neutral-600 underline underline-offset-4">{link.label}<ArrowUpRight className="h-4 w-4" aria-hidden="true" /></a>)}</div>
              </div>}
      ...
      {/* FAQ Section */}
      <section id="faq" tabIndex={-1} aria-labelledby="faq-title" className="scroll-mt-20 border-t border-neutral-200 bg-neutral-50">
        <div className="mx-auto max-w-3xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          >
            <motion.div className="text-center" variants={fadeUp}>
              <h2 id="faq-title" className="font-display text-3xl font-light tracking-tight text-neutral-900 md:text-4xl">
                {t('contact.faqTitle')}
              </h2>
              ...
              {faqKeys.map((faq, index) => (
                <div key={index}>
                  <button
                    ...
                    className="flex w-full items-center justify-between py-6 text-left transition-colors hover:text-brand-700"
                  >
                      ...
                      >
                        <div className="pb-6 text-base leading-relaxed text-neutral-600">
                          ...
                          {faq.hasLink && (
                            <Link
                              to={faq.linkTo!}
                              className="mt-3 inline-flex text-sm text-brand-700 underline underline-offset-4 transition-colors hover:text-brand-700"
                            >
                              {t(faq.linkTextKey!)}
                            </Link>
                          )}
