    ...
    return (
      <div className="min-h-screen">
        ...
        >
          ...
          <Link
            to="/shop"
            className="mt-6 flex items-center gap-2 text-sm font-medium tracking-widest text-[#80603c] uppercase transition-colors hover:text-[#80603c]"
          >
    ...
    },
    {
      ...
      render: (product) => (
        <Link
          ...
          className="text-sm font-medium text-neutral-900 transition-colors hover:text-[#80603c]"
        >
          {product.name}
        </Link>
      ),
                  ...
                  {products.map((product) => (
                    ...
                    >
                      <button
                        ...
                        className="absolute right-2 top-2 flex h-7 w-7 items-center justify-center rounded-full bg-neutral-100 text-neutral-500 transition-colors hover:bg-neutral-200 hover:text-neutral-900"
