...
export default function SignUpPage() {
  ...
  useDocumentMeta({
    ...
    description: t('auth.signUp.metaDescription', {
      defaultValue: 'Create your BLE$$ P account to unlock loyalty points, saved addresses and a 10% welcome gift.',
    }),
  });
  ...
  const validate = (): boolean => {
    ...
    if (!confirmPassword)
      errs.confirmPassword = t('auth.signUp.confirmPasswordRequired');
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-6" noValidate>
                  ...
                  <div className="mt-3 space-y-2.5">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className={cn(
                        ...
                        strength === 'good' && 'text-[#80603c]',
                        strength === 'fair' && 'text-yellow-800',
                      ...
                      {checks.map((check) => (
                        <div key={check.label} className="flex items-center gap-1.5">
                          ...
                          <span className={cn(
                            ...
                            check.met ? 'text-neutral-600' : 'text-neutral-500',
                          )}>
                            {t(check.label)}
                          </span>
                        </div>
          ...
          <div>
            ...
            <div className="flow-root min-h-6" aria-live="polite">
              <AnimatePresence>
              ...
              <AnimatePresence>
                {(errors.confirmPassword || (confirmTouched && confirmPassword && !passwordsMatch)) && (
                  <motion.p id="confirmPassword-error"
                    initial={{ opacity: 0, y: -4 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0, y: -4 }}
                    className="mt-1.5 text-xs text-red-700"
                  >
                    {errors.confirmPassword || t('auth.signUp.passwordsMismatch')}
                  </motion.p>
                )}
              </AnimatePresence>
            </div>
          ...
          <p className="text-center text-xs text-neutral-500">
            ...
            <Link to="/privacy" className="underline underline-offset-2 transition-colors hover:text-neutral-600">
