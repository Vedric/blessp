    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-32">
      ...
      >
          ...
          <form onSubmit={handleSubmit} className="mt-10 space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="mt-2 block w-full border border-neutral-200 bg-transparent px-4 py-3 text-sm text-neutral-900 placeholder:text-neutral-500 focus:border-neutral-900 focus:outline-none focus:ring-0 transition-colors"
        ...
        <p className="mt-8 text-center text-sm text-neutral-500">
          ...
          <Link
            to="/signin"
            className="font-medium text-neutral-900 underline underline-offset-4 transition-colors hover:text-brand-700"
          >
            Sign In
          </Link>
        </p>
