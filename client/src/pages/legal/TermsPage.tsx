              ...
              >
                ...
                {key === 'acceptance' && (
                  <p>
                    <Link
                      to="/privacy"
                      className="inline-flex items-center text-brand-700 underline underline-offset-4 transition-colors hover:text-brand-700"
                    >
                      {t('privacy.title')}
                    </Link>
                  </p>
        ...
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div variants={fadeUp}>
              <Link
                to="/contact"
                className="mt-4 inline-flex items-center text-sm font-medium tracking-widest text-neutral-900 uppercase transition-colors hover:text-brand-700"
              >
                {t('footer.contactUs')}
              </Link>
            </motion.div>
