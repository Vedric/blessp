...
export default function NotFoundPage() {
  ...
  useDocumentMeta({ title: t('notFound.pageNotFound'), noIndex: true });
  ...
  return (
    <div className="relative flex min-h-[80vh] items-center justify-center overflow-hidden px-4 py-16">
      ...
      >
        ...
        <motion.div
          className="mt-4 h-[2px] w-16 bg-[#a07a52]"
          variants={fadeUp}
        />
        ...
        >
          <div className="relative">
            ...
            <input
              ...
              className="w-full border border-neutral-200 bg-white py-3.5 pl-11 pr-4 text-sm text-neutral-900 placeholder:text-neutral-500 focus:border-[#a07a52] focus:outline-none focus:ring-0 transition-colors"
            />
          </div>
        </motion.form>
        ...
        <motion.div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:gap-6" variants={fadeUp}>
          <Link
            to="/"
            className="inline-flex items-center justify-center bg-neutral-900 px-10 py-4 text-sm font-medium tracking-widest text-white uppercase transition-all duration-300 hover:bg-[#a07a52] hover:text-neutral-950"
          >
          ...
          <Link
            to="/shop"
            className="inline-flex items-center gap-2 text-sm font-medium tracking-widest text-neutral-900 uppercase transition-colors hover:text-[#80603c]"
          >
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {popularLinkKeys.map((link) => (
              <Link
                key={link.href}
                to={link.href}
                className="group flex flex-col items-center gap-2 rounded border border-neutral-100 bg-white/80 px-4 py-4 transition-all hover:border-[#a07a52]/30 hover:bg-[#a07a52]/5"
              >
                <link.icon className="h-4 w-4 text-neutral-500 transition-colors group-hover:text-[#80603c]" />
