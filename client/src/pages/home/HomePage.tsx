    ...
    <div className="min-h-screen bg-[#fcfbf8]">
      ...
      <section className="bg-[#eae5db]">
        <div className="mx-auto grid max-w-[1440px] lg:grid-cols-2">
          ...
          <div className="relative min-h-80 overflow-hidden lg:min-h-[600px]"><img src={useOriginalCover ? '/img/blessp_story.jpeg' : '/img/blessp_story-cover.webp'} alt={t('home.brandStoryImageAlt')} decoding="async" onError={() => setUseOriginalCover(true)} width={2048} height={1536} className="h-full min-h-80 w-full object-cover" /><span aria-hidden="true" className="absolute bottom-7 left-7 font-display text-5xl italic text-white [text-shadow:0_2px_12px_rgba(0,0,0,.8)]">BLE$$ P</span></div>
