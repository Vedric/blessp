...
| --- | --- | --- |
| Identité et marché | Le propriétaire confirme Montréal (Québec), la livraison au Canada uniquement et une entreprise encore en projet. Les mentions contiennent encore `[À compléter]`. Le code encaisse en CAD, à confirmer commercialement. | Préciser la future entité, ses coordonnées, l’hébergeur et la devise d’encaissement. Compléter les textes FR/EN et faire valider les engagements commerciaux. |
...
| Catalogue et stocks | Le propriétaire dispose déjà des produits. CRUD et stock par variante disponibles ; médias saisis par URL ; inventaire commercial restant à renseigner et vérifier. | Renseigner produits, photos, tailles, couleurs, prix et quantités réelles. Vérifier chaque combinaison commercialisée et disposer d’un hébergement durable des médias. Aucun seed de démonstration dans la base commerciale. |
...
1. Préparer le catalogue réel et préciser la future identité de l’entreprise à Montréal, la devise, les tarifs de livraison au Canada, les retours et les besoins comptables.
