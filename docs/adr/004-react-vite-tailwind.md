...
- **Client-rendered page content.** Since the September 2026 remediation, Express supplies product metadata in the initial HTML, canonical URLs, indexing directives, real HTTP 404 responses and catalogue sitemaps. React still renders the page body in the browser. Full prerendering/SSR and real crawler validation remain separate work; metadata delivery alone does not guarantee indexing.
