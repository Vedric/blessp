...
| Renouvellement entre trois onglets, rechargement après déconnexion, panne réseau temporaire | `session-resilience.spec.ts` | Politiques particulières des navigateurs/appareils physiques |
