...
export class OrdersController {
  ...
  lookupGuest = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const { orderNumber, email } = GuestOrderLookupSchema.parse(req.body);
      const order = await this.ordersService.lookupGuestOrder(orderNumber, email);
