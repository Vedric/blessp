...
// Guest-checkout: no authentication required. Email is captured in the body
// so confirmations and receipts can still be sent.
router.post('/guest', ordersController.createGuest);
router.post('/guest/lookup', ordersController.lookupGuest);
