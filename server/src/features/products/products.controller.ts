...
export class ProductsController {
  ...
  list = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      ...
      const result = await this.productsService.listProducts(req.baseUrl.includes('/admin/') ? query : { ...query, isActive: true });
  ...
  getOne = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const product = await this.productsService.getProduct(req.params.id as string, req.baseUrl.includes('/admin/'));
  ...
  getVariants = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
      const variants = await this.productsService.getVariants(req.params.id as string, req.baseUrl.includes('/admin/'));
