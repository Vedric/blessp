...
adminProductsRouter.get('/', productsController.list);
adminProductsRouter.get('/:id', productsController.getOne);
adminProductsRouter.post('/', productsController.create);
adminProductsRouter.patch('/:id', productsController.update);
adminProductsRouter.delete('/:id', productsController.delete);
adminProductsRouter.get('/:id/variants', productsController.getVariants);
adminProductsRouter.put('/:id/variants', productsController.updateVariants);
