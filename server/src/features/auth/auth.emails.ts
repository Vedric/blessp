    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;max-width:600px;">
          ...
          ${
            data.welcomeCouponCode
              ? `
          <!-- Welcome coupon -->
          <tr>
            <td style="padding:0 40px 8px;">
              <div style="border:1px dashed #c8a97e;padding:20px;text-align:center;">
                <p style="margin:0;font-size:11px;letter-spacing:3px;color:#737373;text-transform:uppercase;">
                  Your welcome gift
                </p>
                <p style="margin:8px 0 0;font-size:20px;font-weight:300;color:#171717;">
                  ${data.welcomeCouponPercent ?? 10}% off your first order
                </p>
                <p style="margin:12px 0 0;font-family:'SFMono-Regular',Consolas,monospace;font-size:18px;font-weight:600;color:#171717;letter-spacing:3px;">
                  ${escapeHtml(data.welcomeCouponCode)}
                </p>
                <p style="margin:12px 0 0;font-size:12px;color:#a3a3a3;">
                  Single-use. Apply the code at checkout.
                </p>
              </div>
            </td>
          </tr>
              ...
              <table cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background-color:#c8a97e;padding:14px 32px;text-align:center;">
                    <a href="${escapeHtml(shopUrl)}" style="color:#171717;font-size:14px;font-weight:600;text-decoration:none;letter-spacing:1px;text-transform:uppercase;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;max-width:600px;">
          ...
          <tr>
            <td style="padding:40px 40px 24px;">
              ...
              <p style="margin:12px 0 0;font-size:14px;color:#737373;line-height:1.6;">
                Hi ${escapeHtml(data.firstName)}, we received a request to reset the password for your account.
          ...
          <tr>
            <td style="padding:8px 40px 24px;">
              <table cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background-color:#c8a97e;padding:14px 32px;text-align:center;">
                    <a href="${escapeHtml(data.resetUrl)}" style="color:#171717;font-size:14px;font-weight:600;text-decoration:none;letter-spacing:1px;text-transform:uppercase;">
                      Reset Password
                    </a>
                  </td>
                </tr>
