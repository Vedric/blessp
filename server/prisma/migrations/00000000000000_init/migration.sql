...
CREATE TABLE "mfa_setups" (
    ...
    CONSTRAINT "mfa_setups_pkey" PRIMARY KEY ("user_id")
);
...
-- CreateIndex
CREATE INDEX "products_onfront_order_idx" ON "products"("onfront_order");
...
-- CreateIndex
CREATE UNIQUE INDEX "orders_transaction_key_key" ON "orders"("transaction_key");
...
-- AddForeignKey
ALTER TABLE "mfa_setups" ADD CONSTRAINT "mfa_setups_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
