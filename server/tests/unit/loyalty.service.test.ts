...
describe('LoyaltyService', () => {
  ...
  describe('redeemPoints', () => {
    it('redeems points in valid multiples of 100', async () => {
      ...
      loyaltyRepository.redeem.mockResolvedValueOnce(
        makeLoyaltyTransactionFixture({
          id: 'lt_redeem',
          points: -200,
          type: 'redeemed',
      ...
      expect(loyaltyRepository.redeem).toHaveBeenCalledWith(
    ...
    it('throws ValidationError when balance is insufficient', async () => {
      ...
      expect(loyaltyRepository.redeem).not.toHaveBeenCalled();
    });
  });
